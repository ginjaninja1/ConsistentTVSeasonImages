...
using ConsistentTVSeasonImages.Services;
...
namespace ConsistentTVSeasonImages.Tasks
{
    /// <summary>
    ...
    /// </summary>
    public class ConsistentTVSeasonImagesTask : IScheduledTask
    {
        private readonly ILibraryManager libraryManager;
        private readonly IFileSystem fileSystem;
        private readonly ILogger logger;

        public ConsistentTVSeasonImagesTask(ILibraryManager libraryManager, IFileSystem fileSystem, ILogManager logManager)
        {
            this.libraryManager = libraryManager;
            this.fileSystem = fileSystem;
            this.logger = logManager.GetLogger("ConsistentTVSeasonImages");
        }

        public string Name => "Copy Posters to Folder Images";

        public string Key => "ConsistentTVSeasonImagesTask";
